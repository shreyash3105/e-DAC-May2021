...
select employees.department_id, departments.department_name, employees.first_name from employees, departments where employees.department_id= departments.department_id and employees.employee_id = departments.manager_id;
